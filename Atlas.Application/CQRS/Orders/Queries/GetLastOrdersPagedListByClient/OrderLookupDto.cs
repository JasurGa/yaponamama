    ...
    public class OrderLookupDto : IMapWith<Order>
    {
        ...
        public void Mapping(Profile profile)
        {
            profile.CreateMap<Order, OrderLookupDto>()
                ...
                .ForMember(dest => dest.ToLongitude, opt => opt.MapFrom(src => src.ToLongitude))
                .ForMember(dest => dest.ToLatitude, opt => opt.MapFrom(src => src.ToLatitude))
                .ForMember(dest => dest.IsPickup, opt => opt.MapFrom(src => src.IsPickup));
        }
    }
}
