...
{
    public class UpdatePromoAdvertisePageDto : IMapWith<UpdatePromoAdvertisePageCommand>
    {
        ...
        {
            profile.CreateMap<UpdatePromoAdvertisePageDto, UpdatePromoAdvertisePageCommand>()
