...
{
    public class UpdatePushNotificationDto : IMapWith<UpdatePushNotificationCommand>
    {
        ...
        {
            profile.CreateMap<UpdatePushNotificationDto, UpdatePushNotificationCommand>()
